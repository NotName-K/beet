...
class MainWindow(QMainWindow):
    """
    Ventana principal de PyQt6. Construye la interfaz por código.
    No contiene lógica de negocio ni parsers: solo muestra lo que
    devuelve el VisorController y reenvía eventos de UI hacia él.
    """
    ...
    def _setup_ui(self):
        ...
        # ── Splitter central: lista de partidos | tabs ──
    ...
    def _conectar_senales(self):
        ...
        self.partido_list.partido_seleccionado.connect(
            self._on_partido_seleccionado
        )
    ...
    # ------------------------------------------------------------------
    # Slots — eventos de UI hacia el controller
    # ------------------------------------------------------------------
