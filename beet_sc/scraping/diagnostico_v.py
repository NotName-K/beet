...
fixtures, no toca nada del pipeline real. Vive en beet/debug/ (utilidad de
debug manual, no forma parte del pipeline productivo); importa obtener_v.py
desde beet/scraping/ agregando esa carpeta al sys.path.
